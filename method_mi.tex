...
\begin{frame}{Rubin's Rules}
 \begin{itemize}
  ...
  $$T=\bar{U}+B +\frac{B}{m}$$
  \item To do inference, assume that the complete sample estimate $\hat{Q}\sim N(Q,U)$, 
  where U is the variance-covariance of $(Q-\hat{Q})$
