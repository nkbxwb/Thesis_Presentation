 ...
 \begin{itemize}
  ...
  \begin{itemize}
   ...
   \begin{itemize}
    ...
    \item Thus differences after treatment is due to treatment
   \end{itemize}
  \end{itemize}
  
   \item We only have observational data
   \begin{itemize}
   \item Thus differences could be attributed to the drug or confounding factor, e.g.
   
   \begin{itemize}
    \item Healthier patients can tolerate chemo better
    \item Different cancer manifestations lead to different plan\\~\\
   \end{itemize}
